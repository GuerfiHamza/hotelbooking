  <div class="bg-[#0d0d0d]">
    ...
    <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5"></path>
        ...
        <div class="hidden lg:flex lg:gap-x-8 items-center">
          ...
          <a href="#" class="text-sm font-semibold leading-6 text-white rounded-lg px-3 py-2 hover:bg-black transition-colors">Contact</a>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-900">Home</a>
                ...
                <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-900">Contact</a>
